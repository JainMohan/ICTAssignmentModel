...
public class TC_03_Searchitem extends ExtendReportMethod{

@Test
    public void searchAndSelectProduct()throws IOException {
    test = reports.createTest ("searchAndSelectProduct");
