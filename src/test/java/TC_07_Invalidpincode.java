...
public class TC_07_Invalidpincode extends ExtendReportMethod{
    @Test
    public void invalidpincode() throws IOException {

        test = reports.createTest ("invalidpincode");
        ...
        driver.findElement (By.id ("pincodeInputId")).sendKeys ("265789" + Keys.ENTER);
